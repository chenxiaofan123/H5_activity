              ...
              <div class="newUserText">
                ...
                <div class="group">
                  ...
                  <div class="targetList">
                        <div class="targ">
                            <div class="targTop clearfix"><span class='left'>安心智选15天</span><span class="topTip"></span></div>
...
export default {
  ...
  mounted() {
        //从url上截取参数
        this.dataObj.channelCode = this.getUrlVars()['channelCode']||'prizeDrawRegist';
