<template>
    <div class="index-page" v-cloak>
      <header class="top">
          <div class="tipText clearfix">
              <div class="left text">活动开始时间：6月6日 11:00</div>
              <div class="left  remindButton" v-if="!isRemind" @click="remindMe">提醒我</div>
              <div class="left  remindButton" v-if="isRemind" @click="cancleRemind">取消提醒</div>
          </div>
      </header>
      <div class="middle">
            ...
            <div class="whiteContent">
              ...
              <div class="tips">
                  <div class="iconAll" >
                    ...
                    <div class="iconText" >
                      1-3名，分别获得3000元、2000元、1000<span>元现金红包</span>
                    </div>
                  </div>
                  <div class="iconAll" >
                    <div class="iconImg" >
      ...
      <div class="bottom">
          <div class="bottomButton" @click="goRule()">活动细则</div>
      </div>
...
var content =  basePath+"/html/pages/anActivityPreheatOrder/?t=1";
var calenderParam = {
        title: "活动：11点开始黄金钱包答题2019年6月6日",
        content: content,
        startTime:"2019-06-06 11:00:00",
        endTime:"2019-06-06 11:05:00",
        remindTime:"2019-06-06 11:01:00"
}
export default {
  data() {
    return {
  ...
  methods: {
    getRemindStatus(){
      let that = this;
      var param = calenderParam
      //调用Add提醒原生接口--------------------------------------------------------------------
      clientInit.done(function() {
          GB.utils.callCustomMethod("queryCalendarEvent", param, function(
            responseData
          ) {
            var responseDatas = JSON.parse(responseData);
              console.log(responseDatas)
              //alert(responseDatas.result+'结果')
    ...
    cancleRemind(){
      ...
      //调用Add提醒原生接口--------------------------------------------------------------------
      GB.utils.callCustomMethod("removeCalendarEvent", param, function(
        responseData
      ) {
        var responseDatas = JSON.parse(responseData);
        console.log(responseDatas)
  ...
  .px2px(font-size,28);
   ...
   .top{
      ...
      .tipText{
        ...
        .remindButton{
           .bg-img("tip.png",160,64);
           color: #450A2D;
           font-weight: bold;
           box-shadow: 4px 5px 0px #01177E;
